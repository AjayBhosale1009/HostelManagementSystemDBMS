                    ...
                    <label for="others">Others</label>
                        ...
                        <div class="form-actions">
                            <div class="text-center">
                                <!-- <button type="submit" class="btn btn-primary" onclick="fetch_details()">Fetch Details</button> -->
        ...
        xhr.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                if (response.status === "success") {
                    ...
                    // Clear the regno field and display an alert
                    alert("No student found with this registration number.");
                    document.getElementById("regno").value = "";  // Clear the regno field
                }
            }
        };
